...
public class Level1 {
    ...
    /*public static void main(String[] args) {
        ...
        System.out.println(BastShoe( "1 123123" ));
        System.out.println(BastShoe( "1 34" ));
        ...
        System.out.println(BastShoe("1 123"));
        System.out.println(BastShoe("2 1"));
        System.out.println(BastShoe("1 1222"));
    ...
    public static String BastShoe(String command){
        try {
            ...
            if (command.length() > 2) {
                number = String.valueOf(command.charAt(0)) + command.charAt(1);
